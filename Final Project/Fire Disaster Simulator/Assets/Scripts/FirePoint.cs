...
public class FirePoint : MonoBehaviour
{
    ...
    [Tooltip("Rate of burning")]
    public float m_combustionRateValue = 0f;
        ...
        GameObject manager = GameObject.FindWithTag("Fire");
            ...
            if (manager != null)
            {
                ...
                if (fireManager != null)
                {
                    ...
                    if (m_combustionRateValue == 0)
                        m_combustionRateValue = transform.parent.gameObject.GetComponent<FireBurnable>().m_combustionRateValue;
    ...
    public void InstantiateFire(Vector3 position, GameObject Fire)
    {
        ...
        {
            m_fire = (GameObject)Instantiate(Fire, position, new Quaternion(),transform);
